...
%stress strain data for 7075

filename = '7075_stress_strain_data_2.txt';
...
original_length = 39.930624000000000;
...
E = (sigma(4000) - sigma (100))/(strain(4000) - strain(100));


figure, plot(strain,sigma)
xlabel('Strain')
ylabel('Stress (Pa)')
title('7075-T6 Aluminium Stress-Strain Curve')
ax = gca;
ax.YAxis.Exponent = 6;
dim = [0.5 0.3 0.3 0.3];
str = {'Modulus of Elasticity = 71.26 GPa','Yield Strength = 530 MPa'};
