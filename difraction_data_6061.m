...
filename = 'Diffraction_data_6061_2.txt';
...
%make new variables for error bars(were way to small to add to graph)
for i = 1:length(Axial_Spacing)
...
% title('6061-T6 Residual Stress in the Axial Direction')
...
% title('6061-T6 Residual Stress in the Transverse Direction')
% xlabel('Position Along the Samples Cross Section (mm)')
...
title('6061-T6 Residual Stress Distribution')
